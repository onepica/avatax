...
/**
 * Avatax admin landedcost abstract grid
 *
 * @category   OnePica
 * @package    OnePica_AvaTax
 * @author     OnePica Codemaster <codemaster@onepica.com>
 */
abstract class OnePica_AvaTax_Block_Adminhtml_Landedcost_Abstract_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
