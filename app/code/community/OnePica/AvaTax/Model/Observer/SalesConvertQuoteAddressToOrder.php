...
class OnePica_AvaTax_Model_Observer_SalesConvertQuoteAddressToOrder extends OnePica_AvaTax_Model_Observer_Abstract
{
    ...
    public function execute(Varien_Event_Observer $observer)
    {
        ...
        $order->setAvataxLandedCostImportDutiesAmount($quoteAddress->getAvataxLandedCostImportDutiesAmount());
        $order->setBaseAvataxLandedCostImportDutiesAmount($quoteAddress->getBaseAvataxLandedCostImportDutiesAmount());
