 ...
 * @author     OnePica Codemaster <codemaster@onepica.com>
 */
class OnePica_AvaTax_Model_Export_Entity_Order_SalesQuote extends OnePica_AvaTax_Model_Export_Entity_Order_SalesAbstract
{
    /**
    ...
    {
        $tableName = $this->getResource()->getTableName('sales/quote');
    ...
    protected function _getCollection()
    {
        ...
        if ($this->getQuoteId()) {
            $collection->addFieldToFilter('entity_id', $this->getQuoteId());
        }
