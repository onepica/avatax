 ...
 * @author     OnePica Codemaster <codemaster@onepica.com>
 */
class OnePica_AvaTax_Model_Export_Entity_Order_Creditmemo extends OnePica_AvaTax_Model_Export_Entity_Order_SalesAbstract
{
    /**
    ...
    {
        $tableName = $this->getResource()->getTableName('sales/creditmemo');
