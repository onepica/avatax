...
$attributeCode = OnePica_AvaTax_Helper_LandedCost::AVATAX_PRODUCT_LANDED_COST_ATTR_UNIT_OF_WEIGHT;
...
if (!$attribute->getId()) {
    $installer->addAttribute('catalog_product', $attributeCode, array(
        ...
        'input'            => 'select',
        'class'            => '',
        'source'           => 'avatax/adminhtml_system_config_source_unitOfWeight',
